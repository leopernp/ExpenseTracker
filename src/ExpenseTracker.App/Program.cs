using ExpenseTracker.App.Configuration;
using ExpenseTracker.App.Hubs;
using ExpenseTracker.App.Services.BackgroundServices;
...
using ExpenseTracker.Data.Helpers;
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File(
        $"Logs/ExpenseTracker-{processId}-.txt",
