using ExpenseTracker.App.Mapping;
...
using System.Text;
using ExpenseTracker.Contract.Models;
using ExpenseTracker.Contract.Interfaces;
using ExpenseTracker.Data.Repositories;
using ExpenseTracker.Data.Context;
using ExpenseTracker.Data.Repositories.Tools;
using ExpenseTracker.Data.Mapping;

namespace ExpenseTracker.App.Configuration;
    ...
    private static void RegisterBaseRepositories(IServiceCollection services)
    {
        ...
        foreach (var repositoryType in repositoryTypes)
        {
            var contractInterfaces = repositoryType.GetInterfaces()
                .Where(@interface => @interface.Namespace == "ExpenseTracker.Contract.Interfaces"
